            ...
            <div className="flex flex-col md:grid grid-cols-2 py-10">
                <div className="flex flex-col justify-center">
                    ...
                    <div className="flex gap-5 mt-5">
                        <a href="#" className="btn bg-discord text-lg text-white outline-discord"><FontAwesomeIcon icon={ faDiscord } /> Discord</a>
                        <a href="#" className="btn bg-primary text-lg text-slate-800 outline-primary"><FontAwesomeIcon icon={ faWikipediaW } /> Wikipedia</a>
                    </div>
                </div>
